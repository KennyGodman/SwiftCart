    ...
    label: "Men", icon: "👔", categories: {
      shirts: {
        label: "Shirts & Tops", emoji: "👕", items: [
          ...
          { id: "m-s6", name: "Flannel Overshirt", price: 65, oldPrice: 80, desc: "Brushed flannel, double chest pocket", img: "https://images.unsplash.com/photo-1588359348347-9bc6cbbb689e?w=400&q=80" },
          { id: "m-s7", name: "Knit Polo Shirt", price: 48, oldPrice: 65, desc: "Fine knit cotton, ribbed collar & cuffs", img: "https://images.unsplash.com/photo-1581655353564-df123a1eb820?w=400&q=80" },
        ],
      },
      trousers: {
      ...
      belts: {
        label: "Belts", emoji: "🪢", items: [
          ...
          { id: "m-b6", name: "Suede Dress Belt", price: 38, oldPrice: 52, desc: "Genuine brushed suede, brushed steel buckle", img: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&q=80" },
          { id: "m-b7", name: "Braided Leather Belt", price: 42, oldPrice: 55, desc: "Intricately hand-woven leather cords", img: "https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=400&q=80" },
        ],
      },
      caps: {
        label: "Headwear", emoji: "🧢", items: [
          ...
          { id: "m-c6", name: "Beanie Knit", price: 18, oldPrice: 25, desc: "Merino wool, ribbed cuff", img: "https://images.unsplash.com/photo-1576871337622-98d48d1cf531?w=400&q=80" },
          { id: "m-c7", name: "Merino Wool Beanie", price: 24, oldPrice: 32, desc: "Ultra-soft merino, dynamic thermal weave", img: "https://images.unsplash.com/photo-1576871337622-98d48d1cf531?w=400&q=80" },
        ],
      },
      shoes: {
        label: "Footwear", emoji: "👟", items: [
          ...
          { id: "m-sh6", name: "Loafer Slip-On", price: 98, oldPrice: 120, desc: "Horsebit detail, leather lining", img: "https://images.unsplash.com/photo-1631984564919-1f6e59f72f73?w=400&q=80" },
          { id: "m-sh7", name: "Suede Desert Boot", price: 125, oldPrice: 160, desc: "Crepe sole, water-repellent suede upper", img: "https://images.unsplash.com/photo-1520639888713-7851133b1ed0?w=400&q=80" },
        ],
      },
    },
  },
    ...
    label: "Women", icon: "👗", categories: {
      shirts: {
        label: "Tops & Blouses", emoji: "👚", items: [
          ...
          { id: "w-s6", name: "Wrap Cardigan", price: 55, oldPrice: 70, desc: "Cashmere blend, tie-waist", img: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=400&q=80" },
          { id: "w-s7", name: "Linen V-Neck Blouse", price: 48, oldPrice: 65, desc: "Relaxed linen, shell button front", img: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=400&q=80" },
        ],
      },
      trousers: {
        label: "Bottoms", emoji: "👗", items: [
          ...
          { id: "w-t6", name: "Tailored Wide-Leg", price: 88, oldPrice: 110, desc: "Crepe fabric, pleat front", img: "https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=400&q=80" },
          { id: "w-t7", name: "Paperbag Linen Shorts", price: 42, oldPrice: 58, desc: "Tie-waist belt, breezy linen fabric", img: "https://images.unsplash.com/photo-1583496661160-fb5886a0aaaa?w=400&q=80" },
        ],
      },
      belts: {
        label: "Belts", emoji: "🪢", items: [
          ...
          { id: "w-b6", name: "Studded Suede Belt", price: 35, oldPrice: 48, desc: "Gold-tone studs, rich suede strap", img: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=400&q=80" },
          { id: "w-b7", name: "Wide Leather Waist Cinch", price: 48, oldPrice: 65, desc: "Premium smooth leather, statement buckle", img: "https://images.unsplash.com/photo-1624623278313-a930126a11c3?w=400&q=80" },
        ],
      },
      caps: {
        label: "Headwear", emoji: "🎩", items: [
          ...
          { id: "w-c6", name: "Knit Pom Beanie", price: 22, oldPrice: 30, desc: "Chunky knit, removable pom", img: "https://images.unsplash.com/photo-1510598155236-d3e2e31d3e0c?w=400&q=80" },
          { id: "w-c7", name: "Angora Cable Beanie", price: 32, oldPrice: 45, desc: "Warm angora blend, delicate cable knit", img: "https://images.unsplash.com/photo-1576871337622-98d48d1cf531?w=400&q=80" },
        ],
      },
      shoes: {
        label: "Footwear", emoji: "👠", items: [
          ...
          { id: "w-sh6", name: "Kitten Heel Pump", price: 138, oldPrice: 170, desc: "Satin finish, pointed toe", img: "https://images.unsplash.com/photo-1515347619252-60a4bf4fff4f?w=400&q=80" },
          { id: "w-sh7", name: "Pointed Toe Flat", price: 88, oldPrice: 110, desc: "Soft glove leather, cushioned insole", img: "https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=400&q=80" },
        ],
      },
    },
  },
    ...
    label: "Children", icon: "🧒", categories: {
      shirts: {
        label: "Tops & Tees", emoji: "👕", items: [
          ...
          { id: "k-s6", name: "Striped Long Sleeve", price: 22, oldPrice: 30, desc: "Soft jersey, ribbed cuffs", img: "https://images.unsplash.com/photo-1471286174890-9c112ffca5b4?w=400&q=80" },
          { id: "k-s7", name: "Flannel Plaid Shirt", price: 25, oldPrice: 35, desc: "Soft organic flannel, button-up front", img: "https://images.unsplash.com/photo-1519278409-1f56ab241a7d?w=400&q=80" },
        ],
      },
      trousers: {
        label: "Bottoms", emoji: "👖", items: [
          ...
          { id: "k-t6", name: "Cargo Shorts", price: 28, oldPrice: 36, desc: "Ripstop, velcro side pockets", img: "https://images.unsplash.com/photo-1577253313708-cab167d2c474?w=400&q=80" },
          { id: "k-t7", name: "Corduroy Overall Dress", price: 35, oldPrice: 48, desc: "Adjustable straps, front pouch pocket", img: "https://images.unsplash.com/photo-1519689373023-dd07c7988603?w=400&q=80" },
        ],
      },
      belts: {
        label: "Belts", emoji: "🪢", items: [
          ...
          { id: "k-b6", name: "Braided Cotton Belt", price: 15, oldPrice: 22, desc: "Colorful cotton cord, brass hardware", img: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&q=80" },
          { id: "k-b7", name: "Reversible Casual Belt", price: 16, oldPrice: 24, desc: "Two-tone webbed strap, steel buckle", img: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&q=80" },
        ],
      },
      caps: {
        label: "Headwear", emoji: "🧢", items: [
          ...
          { id: "k-c6", name: "Cozy Knit Ear Hat", price: 18, oldPrice: 25, desc: "Soft fleece lining, cute bear ear details", img: "https://images.unsplash.com/photo-1576871337622-98d48d1cf531?w=400&q=80" },
          { id: "k-c7", name: "Straw Sun Visor", price: 16, oldPrice: 24, desc: "Open-top weave, velcro strap back", img: "https://images.unsplash.com/photo-1556306535-0f09a537f0a3?w=400&q=80" },
        ],
      },
      shoes: {
        label: "Footwear", emoji: "👟", items: [
          ...
          { id: "k-sh6", name: "Rain Boots", price: 42, oldPrice: 55, desc: "Natural rubber, easy-pull tab", img: "https://images.unsplash.com/photo-1608256246200-53e635b5b65f?w=400&q=80" },
          { id: "k-sh7", name: "Canvas Slip-On Loafer", price: 35, oldPrice: 46, desc: "Breathable canvas upper, flexible outsole", img: "https://images.unsplash.com/photo-1603487742131-4160ec999306?w=400&q=80" },
        ],
      },
    },
  },
